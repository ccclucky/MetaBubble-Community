    ...
    <div v-if="!flag && index == 0" class="flex flex-1 flex-col p-4 pl-20">
        <div class="flex flex-row w-full h-auto items-start">
            ...
            <div class="flex flex-col flex-1">
                ...
                <div class="flex w-auto h-6 pt-2">
                    <span style="color: #6c84bb;" v-if="!isNotify">{{ reply.username }} @ {{ reply.replyUsername
                        }}</span>
        ...
        reply.createTime
            ...
            <div class="flex flex-1 justify-end items-center cursor-pointer mr-12">
                ...
                <svg @click="likeAndUnlike" v-else t="1701929074092" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="7281" width="20" height="20">
                    <path
